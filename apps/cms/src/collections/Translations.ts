...
export const Translations: CollectionConfig<"translations"> = {
  slug: "translations",
  admin: {
    useAsTitle: "key",
    ...
    components: {
      beforeList: ["@/components/TranslationActions#TranslationActions"],
    },
  },
  access: {
        ...
        try {
          ...
          if (!Array.isArray(data)) {
            return Response.json(
              { error: "Expected an array of translations" },
              { status: 400 },
            );
          }
