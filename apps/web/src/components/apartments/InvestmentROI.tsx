...
import { ChartLineUp as ChartLineUpIcon, TrendUp as TrendUpIcon } from "@phosphor-icons/react/dist/ssr";
...
export const InvestmentROI = ({ rentalYield }: InvestmentROIProps) => {
  const t = useTranslations("apartments");
  if (!rentalYield) return null;

  return (
    <div className="bg-success/5 border border-success/20 rounded-none p-6 md:p-8 flex flex-col gap-4">
      ...
      <div className="flex items-end justify-between bg-white dark:bg-zinc-900 rounded-none p-6 shadow-sm border border-border/50">
        <div>
